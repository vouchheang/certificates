...
function TermofUse2() {
  return (
    <div className=" w-[1920px] h-[1448px] px-0 py-[60px gap-[30px]">
      <div
        className="W-[940px] h-[627px] bg-[#FBFBFB] "
        style={{
          backgroundImage: `url(${Left.src}), url(${Right.src})`,
        }}
      >
        <div className="w-[1920px] h-[1448px] py-[60px] px-0 gap-[30px]">
          <h1 className=" font-semibold leading-[57.8px] text-center text-[34px]">
            Term of Use
          </h1>
          <div className=" w-[1920px] h-[1240px] px-[360px] py-0 gap-[50px]">
            <section className="mb-8 w-[1200px] h-[103px] gap-[10px] ">
              <h2 className="text-2xl font-semibold mb-4 text-[24px] leading-[40.8px]">
                Who we are
              </h2>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 font-medium text-[16px] leading-[25.6px] ">
                ...
                Vivamus enim sed faucibus odio nunc fringilla risus. <br />{" "}
                Sagittis commodo morbi luctus elit aliquet scelerisque est et.
                Aenean ac nibh viverra malesuada massa vitae convallis. Nunc
                massa amet mi sed. Consequat diam fermentum justo integer non a
                fusce vulputate ac. Nisi quis mauris enim urna in leo quisque
                lectus vestibulum. Faucibus eu sagittis velit nulla. Nisl
                aliquam et habitasse ultrices amet. Id praesent sed mauris sit
                at egestas vitae facilisi nec. Nibh id cras quam urna tincidunt
                sit dictum scelerisque vel. Orci mauris faucibus nam morbi cum
                arcu. Est mattis a leo mi. Sed dictumst morbi ante feugiat.
                Natoque vivamus rhoncus at sed sed a.
              </p>
            </section>
            ...
            <section className="mb-8 ">
              ...
              <br />
              <p className="mb-4 font-medium text-[16px] leading-[25.6px] gap-">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 font-medium text-[16px] leading-[25.6px]">
                ...
                and/or
                <span className="mx-[30px]">
                  other information or data we receive or collect, as well as
                  data we
                </span>
                derive or infer from combinations of the foregoing, for variety
                of <span className="mx-[30px]">purposes such as:</span>
              </p>
              <br />
              <section className="mb-8">
                <p className="mb-4 font-medium text-[16px] leading-[25.6px] pl-[20px]">
                  The following are the purposes for which we use your
                  information:
                </p>
                <ul className="mb-4 font-medium text-[16px] leading-[25.6px] pl-[20px]">
                  <li>
                    To facilitate the creation of and secure your account on the
                    SALA
                    <span className="mx-[30px]">Enrollment service.</span>
                  </li>
                  <li>
