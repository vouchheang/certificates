...
function Form(){
    return(
        ...
        <div className="max-w-md w-full">
          ...
          <form className="space-y-4">
            ...
            <input
                ...
                <a href="/forgot-password" className="text-sm  hover:underline flex justify-end">
                 Forgot Password?
                 </a>
                </div>
      ...
      <button className="flex items-center justify-center w-[450px] h-[52px] px-[30px] py-[14px] gap-[10px] border bg-[#00844C] bg-opacity-10 rounded-[6px] shadow-sm  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 opacity-100">
        ...
        />
        <span className=" size-3.5 text-gray-500 font-semibold  leading-4 font-Quicksand w-[150px] h-[18px]">Login with Google</span>
      </button>
    </div>
        </div>
      </div>
