       ...
       <h1 className="font-semibold sm:pt-[15%] max-sm:pt-[15%] md:pt-[15%] lg:pt-[8%] text-center text-[34px] mt-[1%]">
            ...
            <section className="mb-8 w-5/6 m-auto pr-2">
              ...
              <p className="mb-4 font-medium text-[16px] leading-[25.6px] mt-[30px] ">
                ...
                year. select "Remember Me", your login will persist for two
              ...
              <section className="mb-8 ">
                <ul className="mb-4 font-medium text-[16px] leading-[25.6px] pl-[20px] list-disc">
                  ...
                  <li>
                    ...
                    information to d how well each page and station performs
                    overall, based on aggregate listener demographics and
                    traffic patterns to those pages stations. This helps us
                    continue to build a better service for you.
                  </li>
                  ...
                  <li>
                    ...
                    such as sec support and maintenance advisories.
                  </li>
                </ul>
              </section>
            </section>
